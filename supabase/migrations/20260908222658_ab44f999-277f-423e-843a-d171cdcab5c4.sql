...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.defis TO authenticated;
GRANT ALL ON public.defis TO service_role;
GRANT SELECT, INSERT, UPDATE, DELETE ON public.defis_releves TO authenticated;
GRANT ALL ON public.defis_releves TO service_role;
GRANT SELECT ON public.defis_releves TO anon;