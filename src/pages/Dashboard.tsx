          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-12 gap-4 animate-fade-in">
            <div>
              <h1 className="text-4xl md:text-5xl font-bold mb-2">
                Mes <span className="bg-gradient-hero bg-clip-text text-transparent">événements</span>
              </h1>
              ...
              {events.map((ev) => (
                ...
                >
                  <div className="flex items-start justify-between mb-4">
                    <div className="px-3 py-1 bg-accent rounded-full text-xs font-medium text-accent-foreground capitalize">
                      {ev.event_type}
                    </div>
