...
const translations: Record<Lang, Dict> = {
  fr: {
    ...
    auth: {
      ...
      forgotNeedEmail: "Indiquez d'abord votre adresse e-mail.",
      forgotSent: "Lien envoyé",
      forgotSentDesc: "Si un compte existe avec cette adresse, vous recevez un lien pour entrer et choisir un nouveau mot de passe.",
      signingIn: "Connexion...",
  ...
  en: {
    ...
    auth: {
      ...
      forgotNeedEmail: "Please enter your email address first.",
      forgotSent: "Link sent",
      forgotSentDesc: "If an account exists with this address, you will receive a link to sign in and choose a new password.",
