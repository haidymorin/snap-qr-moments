...
const translations: Record<Lang, Dict> = {
  fr: {
    ...
    guest: {
      ...
      hint1: "Photos et vidéos · vidéos jusqu'à 1 Go, sans perte de qualité",
      ...
      errVideoTooBig: "vidéo trop lourde, 1 Go maximum",
  ...
  en: {
    ...
    guest: {
      ...
      hint1: "Photos and videos · videos up to 1 GB, no quality loss",
      ...
      errVideoTooBig: "video too large, 1 GB maximum",
