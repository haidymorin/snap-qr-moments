...
const translations: Record<Lang, Dict> = {
  fr: {
    guest: {
      ...
      hint1: "Photos et vidéos · vidéos limitées à 50 Mo, environ 20 secondes",
      ...
      errVideoTooBig: "vidéo trop lourde, 50 Mo maximum",
      errFormat: "format non reconnu",
      errNetwork: "connexion perdue",
  ...
  en: {
    guest: {
      ...
      hint1: "Photos and videos · videos limited to 50 MB, about 20 seconds",
      ...
      errVideoTooBig: "video too large, 50 MB maximum",
